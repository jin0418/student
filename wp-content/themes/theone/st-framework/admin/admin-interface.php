...
<form action="admin.php?page=<?php echo $_REQUEST['page']; echo (defined('ICL_LANGUAGE_CODE')) ? '&lang='.ICL_LANGUAGE_CODE : ''; ?>" method="post"  enctype="multipart/form-data" >
        ...
        <div class="STpanel-header">
            <div class="STpanel-h-info">
                ...
                <div id="st_version">
                    ...
                    <p class="framework_version"><?php echo __('ST Framework','smooththemes').' '; ?> </p>
                </div>
