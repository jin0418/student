...
class STFlickrWidget extends WP_Widget {
         function STFlickrWidget() {
            ...
            $this->WP_Widget('STFlickrWidget', __('ST Flickr Gallery', 'smooththemes'), $widget_ops);
         }
         ...
         function widget($args, $instance) {
            ...
            // Display
                ...
                echo '<div class="flickr-inner">'; // Containing DIV inner
                ?>
         ...
         function form($instance) {
            ...
            <!-- Flickr ID -->
    		<p>
    			<label for="<?php echo $this->get_field_id( 'flickrID' ); ?>"><?php _e('Flickr ID:', 'smooththemes') ?> (<a href="<?php echo 'http://idgettr.com/'; ?>">idGettr</a>)</label>
